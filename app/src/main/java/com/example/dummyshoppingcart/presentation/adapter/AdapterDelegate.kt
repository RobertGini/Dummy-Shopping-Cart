...
fun promoAdapterDelegate(onProductClick: () -> Unit) = adapterDelegateViewBinding<PromotionEntity, DisplayableItem, ItemPromoBinding>(
...
fun categoryAdapterDelegate() = adapterDelegateViewBinding<CategoryListEntity, DisplayableItem, ItemCategoryBinding>(
